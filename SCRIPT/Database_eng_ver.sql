...
INSERT INTO [dbo].[OrderDetail] ([orderId], [dishName], [dishDetail], [quantity], [price])
OUTPUT inserted.id values(1, N'Cà phê', 'S', 1, 30000)
INSERT INTO [dbo].[OrderDetail] ([orderId], [dishName], [dishDetail], [quantity], [price])
OUTPUT inserted.id values(2, N'Cà phê', 'M', 2, 70000)
INSERT INTO [dbo].[OrderDetail] ([orderId], [dishName], [dishDetail], [quantity], [price])
OUTPUT inserted.id values(3, N'Cà phê', 'S', 1, 35000)

--Update order
UPDATE [dbo].[Order] set [orderPrice] = 100000 where [id] = 1
UPDATE [dbo].[Order] set [orderPrice] = 70000 where [id] = 2
UPDATE [dbo].[Order] set [orderPrice] = 35000 where [id] = 3
